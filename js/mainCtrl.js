angular.module('itunes').controller('mainCtrl', function($scope, itunesService){
  ...
  //Our controller is what's going to connect our 'heavy lifting' itunesService with our view (index.html) so our
  // user can see the results they get back from itunes.
 ...
 $scope.getSongData();
  ...
  //is sort the data you got back to be an object in the following format.
    /*
      ...
      Type: "song"
  */
  //the iTunes API is going to give you a lot more details than ng-grid wants. Create a new array and then
  // loop through the iTunes data pushing into your new array objects that look like the above data.
